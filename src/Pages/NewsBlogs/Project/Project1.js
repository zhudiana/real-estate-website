    ...
    <div className="blog1-main-container">
      <div className="blog1-header-content">
        ...
        <div className="blog1-header-text">
          <h1 className="blog1-header-content-text">
            Westview Standard Apartments Events
          </h1>
          <span
      ...
      <div className="header-blog1-photo">
        <img
          ...
          src="https://metropolitanaddis.com/wp-content/uploads/2019/07/westview-standard-apartnements-2000x1714.png"
      ...
      <div className="blog1-blog">
        ...
        <p className="blog1-each-blog">
          ...
          Metropolitan’s Westview Standard affordable homes for sale in Addis
          Ababa is an international standard project which meets all of
        ...
        <p className="blog1-each-blog">
          If you are looking for western quality, comfort and security which is
          affordable, Westview apartments is your best option
        </p>

        <p className="blog1-each-blog">
          We will update you here when we have new event information.
        </p>
      </div>
