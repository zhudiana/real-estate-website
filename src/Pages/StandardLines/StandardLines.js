  ...
  return (
    <div className="Main-container">
      ...
      <div className="StandardLines-body1-container">
        <div className="StandardLines-image-container">
          <img
            ...
            style={{ width: "225px", height: "169px" }}
          />
        </div>
        <div className="StandardLines-body1-paragraph-container">
          <p className="StandardLines-body1-paragraph">
            ...
            supervision are not compromised. Metropolitan’s luxury constructions
            are done by experienced international engineers with strict
            supervision.
          </p>
          <p className="StandardLines-body1-paragraph">
            Location of standard apartments may not be as convenient as luxury
            home but they’re usually located in up and coming neighborhoods
            which makes it suitable for residential apartments.
          </p>
          <p className="StandardLines-body1-paragraph">
          ...
          <p className="StandardLines-body1-paragraph">
            ...
            it comes with kitchen cabinet finishes, floor tiles, water
            insulation features, marble finish, and different fixtures.
          </p>
        </div>
      </div>
      ...
      <div className="StandardLines-body2-container">
        <div>
          <img
            className="StandardLines-background-image"
            src="https://www.metropolitanaddis.com/wp-content/uploads/2019/09/MetroWeb1-1.jpg"
          />
        </div>
        ...
        <div className="StandardLines-body2-paragraph-container">
          <p className="StandardLines-p-body2-header">
          ...
          <p className="StandardLines-p">
            ...
            is an international standard project which meets all of
            Metropolitan’s high-quality standards. The city’s best construction
            meets an ergonomic design at Westview Standard Apartments to provide
            you with functional and convenient homes.
          </p>
          <p className="StandardLines-p">
            If you are looking for western quality, comfort and security which
            is affordable, Westview Standard Apartments is your best option
          </p>
        </div>
      ...
      <div className="LuxuryLines-body6-title">
        <h5 Standard-Lines-title>
          Here you can learn more about standard homes for sale in Ethiopia
        </h5>
      </div>
